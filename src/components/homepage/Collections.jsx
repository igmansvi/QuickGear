        ...
        <div className="product-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8 mb-12">
          {filteredProducts.slice(0, 8).map((product) => (
            <div
              ...
              className="lazy-load product-card bg-white rounded-xl overflow-hidden group cursor-pointer"
              data-category={product.category}
            >
              <div className="product-card-inner transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                <div className="product-image relative h-52 md:h-56 overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100 z-10"></div>
                  <img
